...
//用于显示用户头像。根据传入的属性，组件可以显示不同的头像图片或一个默认的 SVG 图标。
...
<template>
  <!-- 如果传入了 logo 属性，优先显示 logo 作为头像 -->
  <NAvatar v-if="logo" :src="logo" />
  
  <!-- 如果传入了 image 属性，则显示用户头像或默认头像 -->
  ...
  <!-- 如果没有传入 image 属性，则显示一个默认的 SVG 图标 -->
